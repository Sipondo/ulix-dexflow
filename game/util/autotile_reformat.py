...
def autotile_reformat():

    resource_dirs = []

    for dir in list(Path("").glob("resources/*/")):
        if dir.is_dir():
            resource_dirs.append(dir)

    for resource_dir in resource_dirs:
        p = resource_dir / "graphics/autotiles"
        for infile in p.glob("raw/*.png"):
            ...
            for i in range(src_repeats):
                ...
                formatted_img_array[104:112, 88:104] = formatted_img_array[
                    56:64, 88:104
                ]
                ...
                if src_repeats == 1:
                    ...
                    test.save(
                        p / f"slide/{infile.stem}/{infile.stem}_slide_{i}_{500}.png"
                    )

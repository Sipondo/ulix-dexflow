...
class TilesetDefinition:
    ...
    def from_dict(obj: Any) -> "TilesetDefinition":
        ...
        custom_data = from_list(
            lambda x: from_dict(lambda x: x, x), obj.get("customData")
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["customData"] = from_list(
            lambda x: from_dict(lambda x: x, x), self.custom_data
        )
        result["enumTags"] = from_list(
            lambda x: from_dict(lambda x: x, x), self.enum_tags
        )
        result["identifier"] = from_str(self.identifier)
...
class EntityInstance:
    ...
    def from_dict(obj: Any) -> "EntityInstance":
        ...
        return EntityInstance(
            grid, identifier, pivot, tile, def_uid, field_instances, height, px, width
        )
    ...
    def to_dict(self) -> dict:
        ...
        result["__tile"] = from_union(
            [from_none, lambda x: to_class(EntityInstanceTile, x)], self.tile
        )
        result["defUid"] = from_int(self.def_uid)
...
class LayerInstance:
    ...
    def from_dict(obj: Any) -> "LayerInstance":
        ...
        int_grid = from_union(
            [lambda x: from_list(IntGridValueInstance.from_dict, x), from_none],
            obj.get("intGrid"),
        )
